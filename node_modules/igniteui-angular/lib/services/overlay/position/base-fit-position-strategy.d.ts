...
import { HorizontalAlignment, VerticalAlignment, PositionSettings, Size, ConnectedFit, Point } from '../utilities';
export declare abstract class BaseFitPositionStrategy extends ConnectedPositioningStrategy {
     ...
     */
    protected calculateLeft(targetRect: ClientRect, elementRect: ClientRect, startPoint: HorizontalAlignment, direction: HorizontalAlignment, offset?: number): number;
    /**
     ...
     * @param direction Direction in which to show the element
     */
    protected calculateTop(targetRect: ClientRect, elementRect: ClientRect, startPoint: VerticalAlignment, direction: VerticalAlignment, offset?: number): number;
    /**
