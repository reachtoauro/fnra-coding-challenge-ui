...
export declare class IgxDropDirective implements OnInit, OnDestroy {
    ...
    static ɵdir: ɵngcc0.ɵɵDirectiveDefWithMeta<IgxDropDirective, "[igxDrop]", ["drop"], { "_data": "igxDrop"; "dropStrategy": "dropStrategy"; "dropChannel": "dropChannel"; }, { "enter": "enter"; "over": "over"; "leave": "leave"; "dropped": "dropped"; }, never>;
}
/**
 * @hidden
 */
