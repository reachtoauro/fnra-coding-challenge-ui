...
export declare class IgxComboComponent extends DisplayDensityBase implements IgxComboBase, AfterViewInit, ControlValueAccessor, OnInit, OnDestroy, EditorProvider {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<IgxComboComponent, [null, null, null, null, null, { optional: true; }, { optional: true; }, { optional: true; }]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<IgxComboComponent, "igx-combo", never, { "overlaySettings": "overlaySettings"; "id": "id"; "allowCustomValues": "allowCustomValues"; "searchPlaceholder": "searchPlaceholder"; "showSearchCaseIcon": "showSearchCaseIcon"; "valueKey": "valueKey"; "filterable": "filterable"; "disabled": "disabled"; "autoFocusSearch": "autoFocusSearch"; "itemsMaxHeight": "itemsMaxHeight"; "itemHeight": "itemHeight"; "data": "data"; "displayKey": "displayKey"; "groupKey": "groupKey"; "type": "type"; "width": "width"; "itemsWidth": "itemsWidth"; "placeholder": "placeholder"; "ariaLabelledBy": "ariaLabelledBy"; }, { "onSelectionChange": "onSelectionChange"; "onOpening": "onOpening"; "onOpened": "onOpened"; "onClosing": "onClosing"; "onClosed": "onClosed"; "onAddition": "onAddition"; "onSearchInput": "onSearchInput"; "onDataPreLoad": "onDataPreLoad"; }, ["itemTemplate", "headerTemplate", "footerTemplate", "headerItemTemplate", "addItemTemplate", "emptyTemplate", "toggleIconTemplate", "clearIconTemplate"], ["[igxLabel]", "igx-prefix", "igx-hint, [igxHint]", "igx-suffix"]>;
}
/**
 * @hidden
 */
...
//# sourceMappingURL=combo.component.d.ts.map