import { TemplateRef, QueryList, ElementRef, AfterViewInit, AfterContentInit, OnInit, OnDestroy, DoCheck } from '@angular/core';
...
export declare class IgxHierarchicalGridComponent extends IgxHierarchicalGridBaseDirective implements GridType, AfterViewInit, AfterContentInit, OnInit, OnDestroy, DoCheck {
     ...
     * @hidden
     */
    hideActionStrip(event: MouseEvent): void;
    /**
     * @hidden
     */
    ngOnInit(): void;
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<IgxHierarchicalGridComponent, "igx-hierarchical-grid", never, { "id": "id"; "data": "data"; "expandChildren": "expandChildren"; }, {}, ["childLayoutList", "allLayoutList"], ["igx-grid-footer"]>;
}

//# sourceMappingURL=hierarchical-grid.component.d.ts.map