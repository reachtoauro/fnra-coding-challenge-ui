...
export declare class GridBaseAPIService<T extends IgxGridBaseDirective & GridType> {
    ...
    submit_value(): true;
    submit_add_value(): boolean;
    update_add_cell(cell: IgxCell, value: any): IGridEditEventArgs;
    update_cell(cell: IgxCell, value: any): IGridEditEventArgs;
    /**
    ...
    update_row(row: IgxRow, value: any): IGridEditEventArgs;
