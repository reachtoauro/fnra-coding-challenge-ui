...
export declare class IgxRow {
    ...
    createEditEventArgs(includeNewValue?: boolean): IGridEditEventArgs;
...
export declare class IgxGridCRUDService {
    ...
    beginRowEdit(newCell: any): boolean;
    /** Exit row edit mode */
    exitRowEdit(commit: boolean): boolean;
    /** Enters cell edit mode */
    beginAddRow(cell: any): void;
    beginCellEdit(newCell: any): void;
    /** Exit cell edit mode */
    exitCellEdit(): boolean;
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<IgxGridCRUDService, never>;
...
export declare class IgxGridSelectionService {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<IgxGridSelectionService, never>;
