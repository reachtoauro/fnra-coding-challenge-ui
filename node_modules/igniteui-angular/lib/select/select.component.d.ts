...
export declare class IgxSelectComponent extends IgxDropDownComponent implements IgxSelectBase, ControlValueAccessor, AfterContentInit, OnInit, AfterViewInit, OnDestroy, EditorProvider {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<IgxSelectComponent, [null, null, null, { optional: true; }, { optional: true; }, null]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<IgxSelectComponent, "igx-select", never, { "disabled": "disabled"; "value": "value"; "type": "type"; "placeholder": "placeholder"; "overlaySettings": "overlaySettings"; }, { "onOpening": "onOpening"; "onOpened": "onOpened"; "onClosing": "onClosing"; "onClosed": "onClosed"; }, ["toggleIconTemplate", "headerTemplate", "footerTemplate", "hintElement", "label", "children"], ["[igxLabel]", "igx-prefix,[igxPrefix]", "igx-suffix,[igxSuffix]", "igx-hint, [igxHint]", "*", "igx-select-item, igx-select-item-group"]>;
}
